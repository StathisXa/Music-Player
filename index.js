...
const artist_name = ['Nelly', 'Nelly Furtado', 'OneRepublic', 'T.I', 'The Chainsmokers & Coldplay', 'Tinie Tempah'];
const artist_title = ['Just A Dream', 'Say It Right', 'Counting Stars', 'Dead & Gone ft. Justin Timberlake', 'Something Just Like This', 'Written In The Stars'];
